...
{   
	...
	pWind->DrawImage( "Images\\Images\\ToolBars\\Filebar\\FB1.jpg" , 0 , 220 );
	pWind->DrawImage( "Images\\Images\\ToolBars\\Filebar\\FB2.jpg" , UI.FileBarWidth ,220 + UI.FileBarHeight-UI.FileBarTitleHeight );
