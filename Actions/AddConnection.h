...
public:
	...
	bool isvalid(int x, int y, int** vis, int** ifc, int** oth, int x0, int y0, int x2, int y2,int x1,int y1);//the function the determines whether a piont is valied or not

	void LoadConnection(int , int); //To load a connection 
